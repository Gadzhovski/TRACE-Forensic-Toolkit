""" Old version working with the Sleuth Kit binaries """
...
from OLD_BINARIES.old_binaries_database_manager import DatabaseManager
from OLD_BINARIES.old_binaries_evidence_utils import EvidenceUtils
